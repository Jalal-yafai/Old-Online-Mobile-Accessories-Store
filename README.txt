Thanks for purchasing Zapily. Zapily is here to help you with your next project. If you have any questions that are beyond the scope of this help file, please feel free to contact us at contact@hencework.com



Zapily is an advanced, responsive dashboard UI kit built using Bootstrap, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.

It includes 6 different layouts, with one special e-commerce layout, more than 100 HTML files and lots of widgets and custom made reusable components to help you develop your next application.
...
If everything was installed correctly, you should see the jQuery version of Zapily running in http://localhost:9000/
